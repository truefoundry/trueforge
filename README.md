...
- **Sandbox as a tool** - isolated code/file execution (Daytona via Settings, Kubernetes via env config for self-hosted deployments; more providers planned), provisioned only when needed. Secrets stay in the harness.
