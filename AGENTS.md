...
- Release wiring MUST keep dist-free host development, `pnpm smoke`, and packed CJS/ESM consumers working without changes in `tfy-llm-gateway`.
...
- Code under `packages/sdk` is autogenerated and MUST NOT be edited manually; changes belong in the generator or its source, not in the generated output.
