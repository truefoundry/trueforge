...
export const McpServerListEntryAuthStatus = {
    Authenticated: "authenticated",
    AuthenticationRequired: "authentication_required",
    NotRequired: "not_required",
} as const;
export type McpServerListEntryAuthStatus =
    (typeof McpServerListEntryAuthStatus)[keyof typeof McpServerListEntryAuthStatus];
