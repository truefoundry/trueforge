...
export class McpServersClient {
    ...
    private async __list(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/api/v1/legacy/mcp-servers");
    }
     ...
     * @param {TrueHarness.legacy.AuthorizeMcpServersRequest} request
     * @param {McpServersClient.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    private async __authorize(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)),
                `api/v1/legacy/mcp-servers/${core.url.encodePathParam(name)}/authorize`,
            ),
            method: "GET",
            headers: _headers,
        ...
        return handleNonStatusCodeError(
            ...
            _response.rawResponse,
            "GET",
            "/api/v1/legacy/mcp-servers/{name}/authorize",
        );
    }
    ...
    private async __listTools(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)),
                `api/v1/legacy/mcp-servers/${core.url.encodePathParam(name)}/tools`,
            ),
            method: "GET",
            headers: _headers,
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
        ...
        return handleNonStatusCodeError(
            ...
            _response.rawResponse,
            "GET",
            "/api/v1/legacy/mcp-servers/{name}/tools",
        );
    }
}
