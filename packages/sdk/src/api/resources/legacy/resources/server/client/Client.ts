...
export class ServerClient {
    ...
    ): core.HttpResponsePromise<TrueHarness.GetLegacyCapabilitiesResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getCapabilities(requestOptions));
    }

    private async __getCapabilities(
        requestOptions?: ServerClient.RequestOptions,
    ): Promise<core.WithRawResponse<TrueHarness.GetLegacyCapabilitiesResponse>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.GetLegacyCapabilitiesResponse.parseOrThrow(_response.body, {
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/api/v1/legacy/capabilities");
    }
}
