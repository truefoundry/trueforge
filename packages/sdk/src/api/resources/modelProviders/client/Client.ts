...
export class ModelProvidersClient {
    ...
    private async __list(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/api/v1/model-providers");
    }
    ...
    private async __upsert(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "PUT", "/api/v1/model-providers");
    }
