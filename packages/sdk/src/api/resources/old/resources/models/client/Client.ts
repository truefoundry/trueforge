...
export class ModelsClient {
    ...
    ): core.HttpResponsePromise<TrueHarness.ListOldModelsResponse> {
        return core.HttpResponsePromise.fromPromise(this.__list(requestOptions));
    }

    private async __list(
        requestOptions?: ModelsClient.RequestOptions,
    ): Promise<core.WithRawResponse<TrueHarness.ListOldModelsResponse>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.ListOldModelsResponse.parseOrThrow(_response.body, {
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/api/v1/old/models");
    }
}
