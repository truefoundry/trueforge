...
export const InlineSessionAgent: core.serialization.ObjectSchema<
    serializers.InlineSessionAgent.Raw,
    TrueForge.InlineSessionAgent
...
export declare namespace InlineSessionAgent {
