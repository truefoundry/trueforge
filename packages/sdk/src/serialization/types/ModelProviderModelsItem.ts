...
export const ModelProviderModelsItem: core.serialization.ObjectSchema<
    serializers.ModelProviderModelsItem.Raw,
    TrueHarness.ModelProviderModelsItem
...
export declare namespace ModelProviderModelsItem {
