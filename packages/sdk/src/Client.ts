...
import { ModelProvidersClient } from "./api/resources/modelProviders/client/Client.js";
import { ModelsClient } from "./api/resources/models/client/Client.js";
import { OldClient } from "./api/resources/old/client/Client.js";
...
export class TrueHarness {
    ...
    protected _old: OldClient | undefined;
    ...
    public get old(): OldClient {
        return (this._old ??= new OldClient(this._options));
    }
