/** Legacy AgentSpec wire schema — YAML sessions with inline SkillMount skills. */
...
export const LegacyAgentSpecSchema = z
  .object({
  ...
  .openapi('LegacyAgentSpec');

export type LegacyAgentSpec = z.infer<typeof LegacyAgentSpecSchema>;
