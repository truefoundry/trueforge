...
export function mergeUsage(a: CompletionUsage, b: GatewayCompletionUsage | CompletionUsage): CompletionUsage {
  const normalized = b as GatewayCompletionUsage & Partial<CompletionUsage>;
  const gateway = b as GatewayCompletionUsage;
