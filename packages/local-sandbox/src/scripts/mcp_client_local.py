...
Authoritative reference (do not diverge on API/CLI/policy semantics):
  packages/harness/src/core/sandbox/scripts/mcp_client.py

Inlined into TypeScript via scripts/generate-sandbox-scripts.mjs (sandboxScripts.gen.ts),
same pattern as harness sandboxScripts.
"""
