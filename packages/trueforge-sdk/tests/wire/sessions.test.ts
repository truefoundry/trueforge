...
describe("SessionsClient", () => {
    ...
    test("get_or_create_by_external_id (1)", async () => {
        ...
        server
            .mockEndpoint()
            .post("/api/v1/sessions/get-or-create-by-external-id")
            .jsonBody(rawRequestBody)
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
        ...
        const response = await client.sessions.getOrCreateByExternalId({
            agent: {
                name: "name",
            },
    ...
    test("get_or_create_by_external_id (2)", async () => {
        ...
        await expect(async () => {
            return await client.sessions.getOrCreateByExternalId({
                agent: {
                    name: "xy",
                },
                externalId: "x",
