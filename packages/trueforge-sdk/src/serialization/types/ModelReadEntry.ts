...
export const ModelReadEntry: core.serialization.ObjectSchema<serializers.ModelReadEntry.Raw, TrueForge.ModelReadEntry> =
...
export declare namespace ModelReadEntry {
