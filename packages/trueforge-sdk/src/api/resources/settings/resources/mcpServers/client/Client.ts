...
export class McpServersClient {
    ...
    public async list(
    ...
    ): Promise<core.Page<TrueForge.ConfiguredMcpServer, TrueForge.ListMcpServersResponse>> {
        ...
        return new core.Page<TrueForge.ConfiguredMcpServer, TrueForge.ListMcpServersResponse>({
