...
export class WebSearchProvidersClient {
    ...
    ): core.HttpResponsePromise<TrueForge.GetWebSearchProviderCatalogResponse> {
        return core.HttpResponsePromise.fromPromise(this.__list(requestOptions));
    }

    private async __list(
        requestOptions?: WebSearchProvidersClient.RequestOptions,
    ): Promise<core.WithRawResponse<TrueForge.GetWebSearchProviderCatalogResponse>> {
        ...
        if (_response.ok) {
            return {
                data: serializers.GetWebSearchProviderCatalogResponse.parseOrThrow(_response.body, {
