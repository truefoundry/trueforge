...
export class SessionsClient {
     ...
     *
     * @param {TrueForge.GetOrCreateSessionByExternalIdRequest} request
     * @param {SessionsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link TrueForge.BadRequestError}
    ...
    private async __getOrCreateByExternalId(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)),
                "api/v1/sessions/get-or-create-by-external-id",
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.GetOrCreateSessionByExternalIdRequest.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    omitUndefined: true,
