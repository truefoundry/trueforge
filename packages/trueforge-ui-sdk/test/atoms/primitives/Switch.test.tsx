...
describe("Switch", () => {
  it("reports the next controlled value", () => {
    ...
    const { rerender } = render(
      <Switch checked={false} aria-label="Capability" onCheckedChange={onCheckedChange} />,
    );
  ...
  it("does not change while disabled", () => {
    const onCheckedChange = vi.fn();
    render(
      <Switch checked={false} aria-label="Capability" disabled onCheckedChange={onCheckedChange} />,
    );
