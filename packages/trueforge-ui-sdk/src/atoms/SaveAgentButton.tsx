...
function SaveAgentButtonContent({
  ...
  const show = async () => {
    ...
    setDraftSpec({
      ...agentSpec,
      model: { ...agentSpec.model, params: agentSpec.model.params ? { ...agentSpec.model.params } : undefined },
                        ...
                        return (
                          <CatalogRow
                            ...
                            onToggle={() => {
                              ...
                              setDraftSpec({ ...draftSpec, mcpServers: next.map(item => item.value) });
                            }}
                          />
                        );
                      })
                        ...
                        return (
                          <CatalogRow
                            ...
                            onToggle={() => {
                              ...
                              setDraftSpec({ ...draftSpec, skills: next.map(item => item.value) });
                            }}
                          />
                        );
                      })}
