...
export function DraftCapabilitiesPanel({
  ...
  return (
    <div
      className={cn("flex flex-col", divided && "overflow-hidden rounded-xl border border-border")}
    >
        ...
        return (
          <div
            ...
            className={cn(
              ...
              divided && index > 0 && "border-t border-border",
            )}
          >
            ...
            <Switch
              ...
              onCheckedChange={(nextChecked) =>
                onChange({ ...value, [capability.id]: nextChecked })
              }
            />
          </div>
        );
