  ...
  return (
    <CompactLayoutProvider>
      <div
        ...
        className={cn(
          'ml-auto flex h-full w-full max-w-[min(400px,100%)] min-h-0 min-w-0 flex-col border-l border-border bg-background shadow-[-4px_0_24px_color-mix(in_oklab,var(--shadow-color)_6%,transparent)]',
          className,
        )}
      >
        <StackChatPanel />
