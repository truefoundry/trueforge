...
import type { AgentUIServer, CreateSkillRequest, DefinedSkill, SkillCatalogEntry } from '../../server/types.js';
...
function createFakeHost(initial: DefinedSkill[] = []) {
  ...
  const server = { catalog: { skillCatalog } } as unknown as AgentUIServer;
