...
module.exports = {
  ...
  transform: {
    '^.+\\.tsx?$': [
      '@swc/jest',
      {
        jsc: { parser: { syntax: 'typescript', decorators: true, dynamicImport: true }, target: 'es2022' },
    ...
    '^.+\\.m?js$': [
      '@swc/jest',
      {
        jsc: { parser: { syntax: 'ecmascript', dynamicImport: true }, target: 'es2022' },
        module: { type: 'commonjs' },
      },
    ],
  },
  ...
  testMatch: ['<rootDir>/tests/unit/sandbox/kubernetes/**/*.contract.test.ts'],
};
