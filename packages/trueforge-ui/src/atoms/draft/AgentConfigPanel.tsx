...
const DEFAULT_INSTRUCTIONS = 'Enter detailed instructions for your agent. E.g. You are a helpful assistant that helps users plan trips. Always ask clarifying questions before making suggestions...';
        ...
        <Section title="Instructions" description="Define the agent's role, goals, and behavior.">
          ...
          >
            <div className="min-w-0 flex-1">
              ...
              {userMessageCount > 0 ? <p className="text-text-secondary mt-2 text-xs">
