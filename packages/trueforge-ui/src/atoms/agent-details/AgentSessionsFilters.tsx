...
export function AgentSessionsFilters({
  ...
  useEffect(() => {
    ...
    const onPointerDown = (event: PointerEvent) => {
      if (popoverRef.current?.contains(event.target as Node) !== true) setCustomOpen(false);
    };
  ...
  return (
    <div className="flex min-w-0 items-center gap-2">
      ...
      <div className="relative" ref={popoverRef}>
        ...
        {customOpen ? (
          <div className="absolute right-0 z-20 mt-1 flex w-md overflow-hidden rounded-md border border-border bg-card-bg shadow-md">
            <div className="flex min-w-0 flex-1 flex-col gap-2 border-r border-border p-3">
            ...
            <div className="flex max-h-80 w-44 shrink-0 flex-col overflow-y-auto py-1">
              <button
                type="button"
                className={cn(
