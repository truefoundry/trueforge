...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^@truefoundry/utils-core/request-reply$': '<rootDir>/../harness/src/request-reply/index.ts',
    '^@truefoundry/utils-core/request-reply/(.*)$': '<rootDir>/../harness/src/request-reply/$1',
