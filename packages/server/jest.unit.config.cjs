...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^@truefoundry/trueforge-core/request-reply$': '<rootDir>/../harness/src/request-reply/index.ts',
    '^@truefoundry/trueforge-core/request-reply/(.*)$': '<rootDir>/../harness/src/request-reply/$1',
