...
- Pauses for [human approval](/create-agent/tool-approval) on sensitive actions
...
See the [SDK overview](/api/overview).
...
- Also published as a customizable [UI SDK](/ui-sdk/get-started/quickstart) (`@truefoundry/trueforge-ui`): theme it to your organization and launch your own Claude Desktop-like interface, backed by your TrueForge server
...
<CardGroup cols={3}>
  ...
  <Card title="Chat UI" icon="palette" href="/ui-sdk/get-started/quickstart">
...
<CardGroup cols={3}>
  ...
  <Card title="UI SDK reference" icon="book" href="/ui-sdk/reference/trueforge-ui">
