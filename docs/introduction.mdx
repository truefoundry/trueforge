...
<Frame caption="The bundled chat UI: an agent answering on the right, with an expandable summary of its steps (tool calls and reasoning), next to the Agent Config panel where you shape the agent.">
  <img src="/images/chat-ui.png" alt="The TrueForge chat UI: an agent response about recent developments in agentic AI, with a collapsed Agent steps summary of tool calls and thoughts, beside the Agent Config panel showing model, instructions, runtime config, and MCP servers" />
</Frame>
...
<CardGroup cols={3}>
  ...
  <Card title="Sessions" icon="magnifying-glass" href="/sessions">
    Inspect past runs: turns, tool calls, subagents, tokens, and timing.
  </Card>
