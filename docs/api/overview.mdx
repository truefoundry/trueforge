...
In the SDK, use TypeScript `isEventDelta` / `mergeEventDelta` or Python `is_event_delta` / `merge_event_delta`. See [Create and stream a turn](/api/use-agent#create-and-stream-a-turn).
