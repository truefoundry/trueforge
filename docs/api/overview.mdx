...
You can save this spec as a named agent and reference it by name in every session, or pass it inline when creating a session. See the [agent spec reference](/api/agent-spec) for every field.
