...
Set the mode with the `agentConfig` object.
...
Users can chat with agents already in the library but cannot create new ones. "New Chat" is disabled in this mode.
