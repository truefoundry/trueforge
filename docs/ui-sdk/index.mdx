...
- Chat - Streaming responses, Session history, Tool calls and approval workflows, File attachments
- Agents - Agent library with compose new agent option, Sub-agents
- Reasoning traces
