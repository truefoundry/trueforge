...
<Note>
  Standalone / local mode ignores OIDC even if the variables are set. OIDC login applies to hosted deployments (Docker Compose or Helm).
</Note>
  ...
  <Step title="Set the server environment">
    ...
    <Tabs>
      <Tab title="Docker Compose">
        Add the variables to `packages/server/.env` (the source Compose reads):
      ...
      <Tab title="Helm">
        ...
        See the [chart README](https://github.com/truefoundry/trueforge/blob/main/charts/truefoundry-utils/README.md#oidc) for the full values shape.
      </Tab>
    </Tabs>
