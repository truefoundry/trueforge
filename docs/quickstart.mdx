...
<Tabs>
  ...
  <Tab title="Kubernetes (Helm)">
    The Helm chart deploys the server with bundled Postgres and Redis (or point it at your own):
    ...
    | `redis.enabled`        | `true`       | Bundle Redis; set `false` + `externalRedis.url` to bring your own.       |
