...
<Frame caption="In-chat MCP authentication: the turn pauses with a Connect button until the user authorizes the server, then continues.">
  <img src="/images/mcp-in-chat-auth.png" alt="The chat UI showing an MCP Authentication Required panel for the linear server, with Connect and Continue buttons" />
</Frame>
