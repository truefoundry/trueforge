...
| [Tool approval](/create-agent/overview#tool-approval) | Pause before write/destructive MCP tools |
| [Ask User Questions](/create-agent/overview#ask-user-questions) | Structured clarification mid-run |
| [Generative UI](/create-agent/overview#generative-ui) | Charts, tables, and cards streamed into chat |
