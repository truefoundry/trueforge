...
These harness features keep long agent runs accurate, cheaper, and safer.
...
| [Tool approval](/create-agent/tool-approval) | Pause before write/destructive MCP tools |
| [Ask User Questions](/create-agent/ask-user-questions) | Structured clarification mid-run |
| [Generative UI](/create-agent/generative-ui) | Charts, tables, and cards streamed into chat |
