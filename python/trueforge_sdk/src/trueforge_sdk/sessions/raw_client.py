...
class RawSessionsClient:
    ...
    def create_event(
        ...
        *,
        ...
        turn_id: str,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[CreateSessionEventResponse]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "events": convert_and_respect_annotation_metadata(
                    object_=events, annotation=typing.Sequence[SessionInboundEventItem], direction="write"
                ),
                "turn_id": turn_id,
            },
            headers={
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=CreateSessionEventResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawSessionsClient:
    ...
    async def create_event(
        ...
        *,
        ...
        turn_id: str,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[CreateSessionEventResponse]:
        """
        Create inbound events (`user.tool_approval`, `user.tool_response`, `user.tool_approval_policy`) in the durable session inbox for a tip `turn_id`. Only the session creator may create. Events are stored unconsumed; applying them to the turn is a separate step.
